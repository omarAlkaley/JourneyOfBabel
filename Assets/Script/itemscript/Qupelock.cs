...
public class Qupelock : MonoBehaviour
{
    ...
    {
        numberSprites1 = Resources.LoadAll<Sprite>("Sprites/Qupenumbers1");
        numberSprites2 = Resources.LoadAll<Sprite>("Sprites/Qupenumbers2");
        numberSprites3 = Resources.LoadAll<Sprite>("Sprites/Qupenumbers3");
