...
public class Iaylock : MonoBehaviour
{
    ...
    [HideInInspector]
    public int[] currentIndividualIndex = { 0, 0, };
    ...
    {
        numberSprites1 = Resources.LoadAll<Sprite>("Sprites/lifte");
        numberSprites2 = Resources.LoadAll<Sprite>("Sprites/raitr");
